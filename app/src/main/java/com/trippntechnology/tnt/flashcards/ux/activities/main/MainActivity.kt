...
import com.trippntechnology.tnt.flashcards.views.StaffView
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flashCard.setOnClickListener{
            staffView.setNote(StaffView.TREBLE_CLEF, NoteValue.values()[Random().nextInt(NoteValue.values().size)])
        }
    }
}
